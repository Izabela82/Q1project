...
function cityLocal(value){
  console.log(value);
  var url = "http://apir.viamichelin.com/apir/2/findPoi.json2/RESTAURANT/eng?center=-87.63:41.89&nb=100&dist=10000000&source=RESGR&filter=michelin_stars%20ge%201%20&charset=UTF-8&ie=UTF-8&authKey=RESTGP20170310222038934049903020"
    //  console.log(url);
  $.get(url)
...
function appendResult(json){
  ...
  for (var i = 0; i <json.poiList.length; i++) {
    ...
    var image = json.poiList[i].datasheets[0].medias[0].url_l;
    ...
    // console.log("Rest Name is: " + name);
    //$(".restNames").append(name,description)
  }
  ...
  //   var value = $(this).data("loc");
    ...
    //     console.log(url);
    //     var json = JSON.parse(data);
    //     name = json.poiList[0].datasheets[0].name;
    //
    //   console.log(name);
    //
    //   for (var i = 0; i <json.poiList.length; i++) {
    //     console.log(json.poiList[i].datasheets[0].name);
    //   }
      // displayData(data);

      //
      // http://apir.viamichelin.com/apir/2/findPoi.json2/RESTAURANT/eng?center=-73.…0ge%203%20&charset=UTF-8&ie=UTF-8&authKey=RESTGP20170310222038934049903020
      // http://apir.viamichelin.com/apir/2/findPoi.json2/RESTAURANT/eng?center=-122.41:37.77&nb=100&dist=10000000&source=RESGR&filter=michelin_stars ge 3 &charset=UTF-8&ie=UTF-8&authKey=RESTGP20170310222038934049903020
    // });
